...
if (coachesSubmit) {
		...
		customValidates: {
			coachProspectFile: {
				...
				fn: function (field, container) {
					...
					let prospectName = container.querySelector(
						`#coachProspectName${formDataCounter}`
					).value;
					let prospectLastName = container.querySelector(
						`#coachProspectLastName${formDataCounter}`
					).value;
					let prospectHeight = container.querySelector(
						`#coachProspectHeight${formDataCounter}`
					).value;
					let prospectWeight = container.querySelector(
						`#coachProspectWeight${formDataCounter}`
					).value;
					let prospectSchool = container.querySelector(
						`#coachProspectSchool${formDataCounter}`
					).value;
					let prospectCity = container.querySelector(
						`#coachProspectCity${formDataCounter}`
					).value;
					let prospectState = container.querySelector(
						`#coachProspectState${formDataCounter}`
					).value;
					let prospectPosition = container.querySelector(
						`#coachProspectPosition${formDataCounter}`
					).value;
					let prospectYear = container.querySelector(
						`#coachProspectYear${formDataCounter}`
					).value;
					let prospectLink = container.querySelector(
						`#coachProspectLink${formDataCounter}`
					).value;
			...
			coachData: {
				...
				fn: function (field, container) {
					...
					let fileValue = container.querySelector(
						`#inputFile${formDataCounter}`
					).value;
	...
	addTemplateBtn.addEventListener("click", function () {
		formCounter++;
		let nextForm = document.querySelector(
			`.js-form-template[data-counter="${formCounter}"]`
		);
	...
	formTemplateWrapper.addEventListener("click", e => {
		if (e.target.classList.contains("form-remove")) {
			let currentForm = document.querySelector(
				`.js-form-template[data-counter="${formCounter}"]`
			);
